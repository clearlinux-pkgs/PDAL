...
Version  : 2.7.2
Release  : 32
URL      : https://github.com/PDAL/PDAL/releases/download/2.7.2/PDAL-2.7.2-src.tar.gz
Source0  : https://github.com/PDAL/PDAL/releases/download/2.7.2/PDAL-2.7.2-src.tar.gz
...
%prep
%setup -q -n PDAL-2.7.2-src
cd %{_builddir}/PDAL-2.7.2-src
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719945822
mkdir -p clr-build
pushd clr-build
...
-DWITH_TESTS=NO  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libpdal_plugin_kernel_fauxplugin.so.17
/usr/lib64/libpdal_plugin_kernel_fauxplugin.so.17.1.0
/usr/lib64/libpdal_plugin_reader_pgpointcloud.so.17
/usr/lib64/libpdal_plugin_reader_pgpointcloud.so.17.1.0
/usr/lib64/libpdal_plugin_writer_pgpointcloud.so.17
/usr/lib64/libpdal_plugin_writer_pgpointcloud.so.17.1.0
/usr/lib64/libpdalcpp.so.17
/usr/lib64/libpdalcpp.so.17.1.0
