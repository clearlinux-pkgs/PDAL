...
Patch1: 0001-Fix-permissions-on-usr-include-pdal.patch
...
%prep
%setup -q -n PDAL-2.6.0-src
cd %{_builddir}/PDAL-2.6.0-src
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701198122
mkdir -p clr-build
pushd clr-build
...
%files data
%defattr(-,root,root,-)
/usr/share/share/bash-completion/completions/pdal
...
/usr/lib64/libpdal_plugin_kernel_fauxplugin.so.16.0.0
/usr/lib64/libpdal_plugin_reader_pgpointcloud.so.16
/usr/lib64/libpdal_plugin_reader_pgpointcloud.so.16.0.0
/usr/lib64/libpdal_plugin_writer_pgpointcloud.so.16
/usr/lib64/libpdal_plugin_writer_pgpointcloud.so.16.0.0
/usr/lib64/libpdalcpp.so.16
/usr/lib64/libpdalcpp.so.16.0.0
